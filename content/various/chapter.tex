...
\section{Misc. algorithms}
	...
	\kactlimport[--caption=SNOOB]{SameNumberOfOneBit.h}

\section{Dynamic programming}
	\kactlimport{KnuthDP.h}
	\kactlimport[--caption=DnC-DP]{DivideAndConquerDP.h}
...
\section{Optimization tricks}
	...
	\subsection{Pragmas}
		...
		\end{itemize}
		Use \lstinline{g++ -O2 -g -fverbose-asm -S file.cpp} to compile to assembly \lstinline{file.s}.
